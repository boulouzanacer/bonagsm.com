...
<div class="max-w-6xl space-y-4">
    ...
    <div class="rounded-[24px] p-5 border border-red-400/20 bg-gradient-to-br from-red-500/10 via-transparent to-amber-500/10">
        <div class="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            ...
            <form method="POST"
                  action="{{ url('/fournisseur/base-de-donnees/unlock') }}"
        ...
        <form method="POST"
              action="{{ url('/fournisseur/base-de-donnees/reset') }}"
              class="mt-5"
