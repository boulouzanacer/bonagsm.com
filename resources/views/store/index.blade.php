            ...
            @forelse($produits as $p)
                ...
                <div class="interactive-lift soft-card product-card-compact group rounded-[24px] overflow-hidden {{ $promoActiveNow && $promoPrice !== null ? 'promo-product-card' : '' }}">
                    ...
                    <div class="product-content">
                        <div class="min-w-0">
                            <a href="{{ url('/produits/'.$p->id) }}" class="product-title block text-[13px] font-extrabold leading-tight text-slate-900 hover:text-[var(--store-primary)]" title="{{ $p->designation }}">
                                {{ $p->designation }}
                            </a>
