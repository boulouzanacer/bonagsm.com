...
class DatabaseToolsController extends Controller
{
    ...
    {
        return view('fournisseur.database-tools', [
            'title' => 'Base de données',
            'database_tools_unlocked' => $this->hasDatabaseToolsAccess($request),
            'database_tables' => $this->getDatabaseTables((int) session('frs_id')),
        ]);
    }
    ...
    {
        return redirect()->to('/fournisseur/base-de-donnees');
    }
}
